...
export default class AlgoliaInput extends Component {
  ...
  render() {
    return (
      <div>
        <TextField style={ this.props.style || { WebkitUserSelect: 'auto', userSelect: 'auto' } } onKeyDown={ this.onKeyUp } hintText={ this.props.placeholder } className={ this.props.className || 'algolia-react-input' } />
      </div>
    );
  }
